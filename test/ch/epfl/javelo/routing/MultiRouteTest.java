...
class MultiRouteTest {
    ...
    void indexOfSegmentAt() {
        ...
        SingleRoute singleRoute5 = new SingleRoute(List.of(new Edge(5,6, point5, point6, 1000, Functions.sampled(new float[]{20,25, 20},1000))));
        ...
        System.out.println(multiRouteFinal.indexOfSegmentAt(3500));
        System.out.println(multiRouteFinal.edges().size());
        System.out.println(multiRouteFinal.edges().get(0).toNodeId());
        System.out.println(multiRouteFinal.edges().get(1).toNodeId());
        ...
        System.out.println(multiRouteFinal.elevationAt(4250));
        System.out.println(multiRouteFinal.nodeClosestTo(1500));
        System.out.println(multiRouteFinal.nodeClosestTo(2600));
        System.out.println(multiRouteFinal.nodeClosestTo(3500));
        System.out.println(multiRouteFinal.nodeClosestTo(4200));
        System.out.println(point5);
        multiRouteFinal.pointAt(4200);
